...
Altered by Christian Skinker. Added additional block type check when configuring avg_buffer path for addition of time tagger. 
"""
...
class AxisReadoutV2(SocIp, AbsReadout):
    ...
    * 1 : Periodic.
    ...
    def configure_connections(self, soc):
        ...
        # might have broadcaster before readout (raw adc sampling)
