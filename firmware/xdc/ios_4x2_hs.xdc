...
#set_property IOSTANDARD LVCMOS18 [get_ports PMOD1_0]
#set_property IOSTANDARD LVCMOS18 [get_ports PMOD1_1]
#set_property IOSTANDARD LVCMOS18 [get_ports PMOD1_2]
#set_property IOSTANDARD LVCMOS18 [get_ports PMOD1_3]
#set_property IOSTANDARD LVCMOS18 [get_ports PMOD1_4]
#set_property IOSTANDARD LVCMOS18 [get_ports PMOD1_5]
#set_property IOSTANDARD LVCMOS18 [get_ports PMOD1_6]
#set_property IOSTANDARD LVCMOS18 [get_ports PMOD1_7]
set_property IOSTANDARD LVCMOS18 [get_ports R_LED_0]
set_property IOSTANDARD LVCMOS18 [get_ports R_LED_1]
set_property IOSTANDARD LVCMOS18 [get_ports {W_LED_tri_o[3]}]
set_property IOSTANDARD LVCMOS18 [get_ports {W_LED_tri_o[2]}]
set_property IOSTANDARD LVCMOS18 [get_ports {W_LED_tri_o[1]}]
set_property IOSTANDARD LVCMOS18 [get_ports {W_LED_tri_o[0]}]
set_property IOSTANDARD LVCMOS18 [get_ports B_LED_0]

set_property PACKAGE_PIN AW16 [get_ports {PMOD01_tri_o[0]}]
set_property PACKAGE_PIN AW15 [get_ports {PMOD01_tri_o[1]}]
set_property PACKAGE_PIN AW14 [get_ports {PMOD01_tri_o[2]}]
set_property PACKAGE_PIN AR16 [get_ports {PMOD01_tri_o[3]}]
set_property PACKAGE_PIN AV16 [get_ports {PMOD01_tri_o[4]}]
set_property PACKAGE_PIN AT16 [get_ports {PMOD01_tri_o[5]}]
