...
## PMOD_0
set_property PACKAGE_PIN G15 [get_ports PMOD0_0]
set_property PACKAGE_PIN G16 [get_ports PMOD0_1]
...
set_property PACKAGE_PIN G13 [get_ports PMOD0_4]
set_property PACKAGE_PIN H13 [get_ports PMOD0_5]
set_property PACKAGE_PIN J13 [get_ports PMOD0_6]
set_property PACKAGE_PIN J14 [get_ports PMOD0_7]
...
## LED GPIO
set_property PACKAGE_PIN AN14 [get_ports {R_LED_tri_o[0]}]
set_property PACKAGE_PIN AP16 [get_ports {R_LED_tri_o[1]}]
set_property PACKAGE_PIN AP14 [get_ports {R_LED_tri_o[2]}]
set_property PACKAGE_PIN AU16 [get_ports {R_LED_tri_o[3]}]
set_property PACKAGE_PIN AW12 [get_ports {R_LED_tri_o[4]}]
set_property PACKAGE_PIN AY16 [get_ports {R_LED_tri_o[5]}]
set_property PACKAGE_PIN BB12 [get_ports {R_LED_tri_o[6]}]
set_property PACKAGE_PIN E25 [get_ports {R_LED_tri_o[7]}]
set_property IOSTANDARD LVCMOS12 [get_ports R_LED*]
